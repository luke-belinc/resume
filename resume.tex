...
\bgroup
\begin{center}
    \fontsize{45}{35}\mlscript Luke Belinc
\end{center}
\egroup
...
\vspace*{-15pt}
\section*{Experience}
\vspace*{-10pt}\workexp{Associate Software Engineer}{Bloomerang}{10/2022}{Current}{%
    \begin{itemize*}
...
\begin{minipage}[t]{0.7\textwidth}%
    ...
    \vspace*{-10pt}\begin{tabular*}{\textwidth}{L{0.425\textwidth} L{0.5\textwidth}}
